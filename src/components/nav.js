...
function Nav() {
    ...
    return(
        <nav onClick={navButton} className='nav_container flex'>
            <Scrollspy items={ ['about', 'easybank', 'rango', 'todo', 'todoreact', 'countdown'] } currentClassName="is-current selected" className="desktop">
                ...
                <a className="nav_element" href='#todoreact'>TODO WITH REACT</a>
                <a className="nav_element" href='#countdown'>COUNTDOWN</a>
            </Scrollspy>

            <Scrollspy items={ ['about', 'easybank', 'rango', 'todo', 'todoreact', 'countdown'] } currentClassName="is-current selected show" className="mobile">
                ...
                <a className="hide nav_element" href='#todoreact'>TODO WITH REACT</a>
